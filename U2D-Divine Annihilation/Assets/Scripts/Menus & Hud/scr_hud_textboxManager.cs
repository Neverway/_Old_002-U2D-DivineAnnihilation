...
*/
public class scr_hud_textboxManager : MonoBehaviour
{
    ...
    private scr_character_movement characterMovement;   // A reference to the character movement script, used to freeze the player when a textbox is up
    private scr_system_configurationManager global;     // A reference to the configuration manager script, used to set the global value of if a menu is active
    ...
    void Start()
    {
        ...
        global = FindObjectOfType<scr_system_configurationManager>();       // Find the configuration manager script
    }
