...
// Purpose: 
// Applied to: 
// Parent script: DAG12_Menu_Control
// Notes: 
//
//=============================================================================
...
[CustomEditor(typeof(DAG12_Menu_Control))]
public class DAG12_Editor_Menu_Control : Editor
{
    //=-----------------=
    // Public variables
    //=-----------------=
    ...
    {
        DAG12_Menu_Control menuControl = (DAG12_Menu_Control)target;                          // Set the current script to the target class
