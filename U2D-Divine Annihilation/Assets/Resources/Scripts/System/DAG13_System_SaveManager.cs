...
public class DAG13_System_SaveManager : MonoBehaviour
{
    ...
    public bool LoadingSavedPosition;
    ...
    private IEnumerator LoadPlayerPosition()
    {
	    ...
	    if (LoadingSavedPosition)
	    {
		    playerCharacter = FindObjectOfType<NUPTopdownController>();
		    print("Wanting to set position");
		    playerCharacter.gameObject.transform.position = new Vector3(activeSaveFile.savePositionX, activeSaveFile.savePositionY, 0);
    ...
    public void CreateNewFile(int _fileIndex)
    {
	    ...
	    activeSaveFile.savePositionX = -12f;
