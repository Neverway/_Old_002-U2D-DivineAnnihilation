...
/* Battle encounter
 * ---------------------
 * This script is applied to a enemy in the overworld
 * It causes the player to enter a battle on collision with the enemy
 * All of this is to setup the battle and after battle conditions
*/
public class BattleEncounter : MonoBehaviour
{
    ...
    // Class references
    public GameObject player;           // Get a reference to the player object in the scene
